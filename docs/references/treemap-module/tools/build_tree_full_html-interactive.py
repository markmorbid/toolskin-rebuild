...
<head>
  ...
  <!-- Toolskin design system - single source of truth.
       ...
       it consumes the canonical assets/css/toolskin.css + assets/js/*. That
  ...
  <script src="assets/js/toolskin-assets.js" defer></script>
  <script src="assets/js/toolskin.js" defer></script>
  <script src="assets/js/toolskin-uikit.js" defer></script>

  <style>

  /* Most of the tree component CSS lives in assets/css/toolskin.css.
