...
var calcContrast = null; // node-only: import { calcContrast } from 'apcach'
var converter = null; // node-only: import { converter } from 'culori'
var fs = null; // node-only: import fs from 'node:fs'
var path = null; // node-only: import path from 'node:path'
var fileURLToPath = null; // node-only: import { fileURLToPath } from 'node:url'

const SCRIPT_DIR = path.dirname(fileURLToPath('' /* import.meta.url — node-only */));
