...
- [x] **typography-master:** change base font-size 16px → **13px** (RULING 3) (Wave 1.6 — running `toolskin.css` confirmed; NOT 13px, NOT 16px). Recompute harmonic-ladder examples from a 15px base. ✅ Session 1.5 — SKILL.md line 75 updated. **RULING 3 correction (2026-05-21):** 13px confirmed from `toolskin.css:287`; the Wave 1.6 visual audit (15px) was an instrumentation error — all 15px references in this line are superseded; canonical base = 13px.
